...
class PluginWrapper {
  ...
  wrap (app, options, storage) {
    if (this.subPlugin && this.plugins[this.subPlugin]) this.realApply = this.plugin[this.subPlugin].apply.bind(this.plugin[this.subPlugin])
  ...
  createWrappedPlugin () {
    ...
    if (this.subPlugin && this.plugins[this.subPlugin]) this.plugin[this.subPlugin].apply = reloadedApplyFunction
